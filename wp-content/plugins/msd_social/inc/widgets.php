...
class MSDConnected extends WP_Widget {
	...
	<div class="clear"></div>
	<div id="digits">
		<?php print (get_option('msdsocial_phone')!='')?'<address class="phone"><a href="tel:'.get_option('msdsocial_phone').'">'.get_option('msdsocial_phone').'</a></address>'.'<br /> ':''; ?>
		<?php print (get_option('msdsocial_email')!='')?'<address class="email"><a href="mailto:'.get_option('msdsocial_email').'">'.strtolower(get_option('msdsocial_email')).'</a></address><br /> ':''; ?>
	</div>
	<div id="address" class="address">
		<?php print (get_option('msdsocial_mailing_street')!='' && get_option('msdsocial_mailing_city')!='' && get_option('msdsocial_mailing_state')!='')?'<address>'.get_option('msdsocial_mailing_street').'</address><address>'.get_option('msdsocial_mailing_street2').'</address><address>'.get_option('msdsocial_mailing_city').''.get_option('msdsocial_mailing_state').' '.get_option('msdsocial_mailing_zip').'</address> ':''; ?>
		<?php print (get_option('msdsocial_street')!='' && get_option('msdsocial_city')!='' && get_option('msdsocial_state')!='')?'<address>'.get_option('msdsocial_street').' '.get_option('msdsocial_street2').'</address><address>'.get_option('msdsocial_city').', '.get_option('msdsocial_state').' '.get_option('msdsocial_zip').'</address> ':''; ?>
	</div>
		<?php 	
		echo $after_widget;
	}
